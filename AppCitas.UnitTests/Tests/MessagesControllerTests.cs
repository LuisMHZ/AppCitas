...
namespace AppCitas.UnitTests.Tests
{
    public class MessagesControllerTests
    {
        ...
        [Theory]
        [InlineData("NotFound", "lisa", "Pa$$w0rd", "masterlol16", "Hola Mundo x2")]
        ...
        [Theory]
        [InlineData("OK", "wagner", "Pa$$w0rd", "lisa", "Hola Mundo x3")]
        ...
        [Theory]
        [InlineData("OK", "rosa", "Pa$$w0rd", "berry", "Hola Mundo x4")]
        ...
        [Theory]
        [InlineData("Unauthorized", "hewitt", "Pa$$w0rd", "lisa", "Hola Mundo x5", "tanner")]
